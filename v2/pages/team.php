                ...
                if (ClanHandler::isQualified($team, $compo)) {
                    ...
                    if (count($playingMembers) != $compo->getTeamSize()) {
                        ...
                        if ($compo->getParticipantLimit() != 0) {
                            echo "<br /><b>Beklager, men ditt lag ble ikke fullt før alle plassene var tatt! Dere har blitt satt på en liste, så dere vil bli kvalifisert om noen andre diskvalifiseres.</b>";
                        }
                    }
                }
            }
