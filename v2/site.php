...
class Site {
	...
	*/      
	...
	if(Session::isAuthenticated()) {
		...
		if($_GET['page']=="compo") {
		    echo '<div id="gameBannerCsGo" class="gameType' .  ($_GET['id'] == "7" ? ' selected' : ''). '" style="width:100px;"><p>CS:GO</p></div>';
		    echo '<div id="gameBannerLoL" class="gameType' .  ($_GET['id'] == "8" ? ' selected' : ''). '" style="width:70px;"><p>LoL</p></div>';
		} else {
		    echo '<div id="gameBannerCsGo" class="gameType" style="width:100px;"><p>CS:GO</p></div>';
		    echo '<div id="gameBannerLoL" class="gameType" style="width:70px;"><p>LoL</p></div>';
		}
